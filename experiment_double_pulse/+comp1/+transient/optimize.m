% parameter optimization script for 1-compartment transient models
...
p.ub        = 30 * ones(1, length(p.parameter_names)); % uS/mm^2
...
filename    = ['data-comp1-transient-' corelib.getComputerName '.mat'];
